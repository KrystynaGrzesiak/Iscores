...
`Iscores` provides scoring rules for evaluating and comparing imputation
methods.

The package implements the methodology introduced in Näf et al. (2022)
and Näf, Grzesiak, and Scornet (2025). The package supports:
...
function evaluates the quality of an imputation method.
...
Several methods can be compared simultaneously using
